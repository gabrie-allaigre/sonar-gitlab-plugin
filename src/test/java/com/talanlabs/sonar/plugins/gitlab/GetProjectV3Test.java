...
public class GetProjectV3Test {
    ...
    public void testProjectIdReturnEmpty() throws Exception {
        ...
        CommitFacade facade = new CommitFacade(gitLabPluginConfiguration);
        Assertions.assertThatThrownBy(() -> facade.init(gitBasedir)).isInstanceOf(IllegalStateException.class).hasMessageContaining("Unable to find project ID 123 Verify Configuration sonar.gitlab.project_id or sonar.gitlab.user_token");
    }
