...
public class InlineCommentBuilderTest {
    ...
    public void testNoIssues() {
        Assertions.assertThat(new InlineCommentBuilder(config, Collections.emptyList(), new MarkDownUtils(settings)).buildForMarkdown()).isEqualTo("");
    }
    ...
    public void testMultiIssue() {
        ...
        Assertions.assertThat(new InlineCommentBuilder(config, ris, new MarkDownUtils(settings)).buildForMarkdown()).isEqualTo(
    ...
    public void testTemplateConfig() {
        ...
        Assertions.assertThat(new InlineCommentBuilder(config, Collections.emptyList(), new MarkDownUtils(settings)).buildForMarkdown())
                .isEqualTo("123\n" + "123456789\n" + "master\n" + "https://gitlab.com\n" + "10\n" + "0\n" + "0\n" + "-1\n" + "-1\n" + "-1\n" + "false\n" + "false\n" + "false");
    }
    ...
    public void testTemplateIssue() {
        ...
        List<Reporter.ReportIssue> ris = Stream.iterate(0, i -> i++).limit(17)
                .map(i -> new Reporter.ReportIssue(Utils.newMockedIssue("component", null, null, Severity.MAJOR, true, "Issue number:" + i, "rule" + i), "lalal", true)).collect(Collectors.toList());
    ...
    public void testTemplateIssueForSeverity() {
        ...
        List<Reporter.ReportIssue> ris = Stream.iterate(0, i -> i++).limit(9)
                .map(i -> new Reporter.ReportIssue(Utils.newMockedIssue("component", null, null, i % 2 == 0 ? Severity.MAJOR : Severity.BLOCKER, true, "Issue number:" + i, "rule" + i), "lalal", true)).collect(Collectors.toList());
    ...
    public void testTemplateIssueReported() {
        ...
        List<Reporter.ReportIssue> ris = Stream.iterate(0, i -> i++).limit(17)
                .map(i -> new Reporter.ReportIssue(Utils.newMockedIssue("component", null, null, Severity.MAJOR, true, "Issue number:" + i, "rule" + i), GITLAB_URL + "/File.java#L" + i, false)).collect(Collectors.toList());
    ...
    public void testTemplateIssueReportedForSeverity() {
        ...
        List<Reporter.ReportIssue> ris = Stream.iterate(0, i -> i++).limit(10)
                .map(i -> new Reporter.ReportIssue(Utils.newMockedIssue("component", null, null, i % 2 == 0 ? Severity.MAJOR : Severity.BLOCKER, true, "Issue number:" + i, "rule" + i), GITLAB_URL + "/File.java#L" + i, false)).collect(Collectors.toList());
    ...
    public void testTemplateIssueOthers() {
        ...
        Assertions.assertThat(new InlineCommentBuilder(config, ris, new MarkDownUtils(settings)).buildForMarkdown()).isEqualTo(":no_entry:\n" +
    ...
    public void testTemplateIssueFail() {
        ...
        Assertions.assertThatThrownBy(() -> new InlineCommentBuilder(config, Collections.emptyList(), new MarkDownUtils(settings)).buildForMarkdown()).isInstanceOf(MessageException.class);
    }
}
